...
import { CreateUserInput } from '../src/user/dtos/user-create.dto';
...
export const seedAdminUser = async (
  ...
  adminUser: UserOutput;
  authTokenForAdmin: UserAuthTokenOutput;
}> => {
  ...
  const authTokenForAdmin: UserAuthTokenOutput = loginResponse.body.data;
